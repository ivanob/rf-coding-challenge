...
export const notificationsSchema = Type.Object(
  {
    ...
    playerId: Type.String({ objectid: true }),
    text: Type.String(),
...
export const notificationsDataSchema = Type.Pick(notificationsSchema, ['playerId', 'text' ], {
...
export const notificationsPatchSchema = Type.Partial(notificationsDataSchema, {
...
export const notificationsQueryProperties = Type.Pick(notificationsSchema, ['_id', 'playerId', 'text', 'timestamp'])
